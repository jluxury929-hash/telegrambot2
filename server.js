/**
 * ===============================================================================
 * APEX PREDATOR: NEURAL ULTRA v9081 (GLOBAL ULTIMATUM EDITION)
 * ===============================================================================
...
// 3. CALLBACK HANDLER (Acknowledge instantly & Update UI)
...
function runStatusDashboard(chatId) {
    ...
    bot.sendMessage(chatId, 
        ...
        `⏳ <b>Execution Term:</b> <code>${SYSTEM.mode}</code>\n\n` +
        `🛡️ <b>Shields:</b> ${SYSTEM.atomicOn ? 'ATOMIC' : 'RAW'}\n` +
        `⚡ <b>Radar:</b> ${SYSTEM.shredSpeed ? 'Geyser gRPC' : 'Standard'}`, 
    { parse_mode: 'HTML' });
}

http.createServer((req, res) => res.end("v9081 READY")).listen(8080);
