    ...
    try {
        ...
        if (netKey === 'SOL') {
            ...
            if (bal < needed) {
                ...
                bot.sendMessage(chatId, ` **[SOL] WARNING:** Insufficient Balance. Have ${bal/LAMPORTS_PER_SOL}, need ${needed/LAMPORTS_PER_SOL} SOL.`);
            ...
            if (bal < needed) {
                ...
                bot.sendMessage(chatId, ` **[${netKey}] WARNING:** Insufficient ETH/BNB for trade + gas.`);
