/**
 * ===============================================================================
 * APEX PREDATOR: NEURAL ULTRA v9085 (GLOBAL ULTIMATUM EDITION)
 * ===============================================================================
...
let SYSTEM = {
    ...
    jitoTip: 20000000, // Priority Fee Supremacy
...
// --- 🔱 2. LAYER 2: MEV-SHIELD INJECTION (Atomic Supremacy) ---
// E = (P_win * Profit) - (P_loss * Cost) | P_loss cost is zero via Jito.
...
Connection.prototype.sendRawTransaction = async function(rawTx, options) {
    ...
    } catch (e) { console.log(`[MEV-SHIELD] ⚠️ Atomic shield active, reverting...`.yellow); }
    return null; // Atomic protection: Never leak failed arbs to public mempool
};

// --- 🔱 3. GLOBAL CONFIG & RADAR ---
...
// --- 🔱 4. MATHEMATICAL ENGINE (Compounding Loop) ---
...
async function checkGlobalArb(chatId) {
    ...
    try {
        ...
        if (delta > SYSTEM.minDelta) {
            console.log(`[ARB] Δ Found: ${delta.toFixed(3)}% - Exploiting Delta`.cyan.bold);
...
bot.onText(/\/(start|menu)/, (msg) => {
    bot.sendMessage(msg.chat.id, "<b>⚔️ APEX OMNI-MASTER v9085</b>\nMathematical Delta Radar Active.", { parse_mode: 'HTML', ...getDashboardMarkup() });
});
...
http.createServer((req, res) => res.end("SYSTEM v9085 READY")).listen(8080);
